...
TEST_CASE("MessageTests")
{
    ...
    SECTION("setString_TrailerStructureInvalid_MessageStructureInvalid")
    {
        ...
        std::string rawFixMsg = "8=FIX.4.2" + delimSOH + "9=200" + delimSOH + "35=A" + delimSOH + "49=SENDER" + delimSOH + "56=TARGET" + delimSOH + "34=1" + delimSOH + "98=0" + delimSOH + "10=200" + delimSOH // Trailer in Body is invalid
    ...
    SECTION("setString_SignatureInTrailerWithoutSignatureLength_InvalidMessageException")
    {
        ...
        FIX::Message msg;
        std::string delimSOH = "\x01";
        std::string rawFixMsg = "8=FIX.4.2" + delimSOH + "9=200" + delimSOH + "35=A" + delimSOH + "49=SENDER" + delimSOH + "56=TARGET" + delimSOH + "34=1" + delimSOH + "98=0" + delimSOH + "108=30" + delimSOH + "89=200" + delimSOH // Signature
                                + "10=200" + delimSOH;
    ...
    SECTION("setStringAndValidate_IncorrectBodyLength_InvalidException")
    {
        ...
        std::string rawFixMsg = "8=FIX.4.2" + delimSOH + "9=2000" + delimSOH // Incorrect BodyLength
                                + "35=A" + delimSOH + "49=SENDER" + delimSOH + "56=TARGET" + delimSOH + "34=1" + delimSOH + "98=0" + delimSOH + "108=30" + delimSOH + "10=200" + delimSOH;
