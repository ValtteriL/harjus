        ...
        for (const SessionID &sessionID : sessions)
        {
...

            {
                ...
                tr.text();
                {
                    TD td(b);
                    td.text();
                    std::string href = "/session?BeginString=" + sessionID.getBeginString().getValue() + "&SenderCompID=" + sessionID.getSenderCompID().getValue() + "&TargetCompID=" + sessionID.getTargetCompID().getValue();
