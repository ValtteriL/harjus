...
TEST_CASE_METHOD(sessionFixture, "SessionTestCase")
{
    ...
    SECTION("lookupSession")
    {
        ...
        CHECK(
            &session1 == Session::lookupSession(SessionID(BeginString("FIX.4.2"), SenderCompID("TW"), TargetCompID("ISLD"))));

        CHECK(
            &session2 == Session::lookupSession(SessionID(BeginString("FIX.4.2"), SenderCompID("WT"), TargetCompID("ISLD"))));

        CHECK(
            &session3 == Session::lookupSession(SessionID(BeginString("FIX.4.2"), SenderCompID("TW"), TargetCompID("DLSI"))));

        CHECK(
            &session4 == Session::lookupSession(SessionID(BeginString("FIX.4.2"), SenderCompID("OREN"), TargetCompID("NERO"))));
    }
    ...
    SECTION("registerSession")
    {
        ...
        CHECK(
            pSession == Session::registerSession(SessionID(BeginString("FIX.4.2"), SenderCompID("TW"), TargetCompID("ISLD"))));
        CHECK(Session::isSessionRegistered(SessionID(BeginString("FIX.4.2"), SenderCompID("TW"), TargetCompID("ISLD"))));
        CHECK(
            nullptr == Session::registerSession(SessionID(BeginString("FIX.4.2"), SenderCompID("TW"), TargetCompID("ISLD"))));
...
TEST_CASE_METHOD(initiatorFixture, "InitiatorSessionTestCase")
{
    ...
    SECTION("messageTagsOutOfOrder_Reject")
    {
        ...
        newOrderSingleRawFIX = "8=FIX.4.2" + delimSOH + "9=114" + delimSOH + "35=D" + delimSOH + "34=2" + delimSOH + "49=ISLD" + delimSOH + "56=TW" + delimSOH + "52=20190517-16:08:43" + delimSOH + "11=ID" + delimSOH + "21=1" + delimSOH + "40=1" + delimSOH + "35=D" + delimSOH // header field out of order and included in body as well
    ...
    SECTION("invalidRawFixMessage_LogonMessageHeaderOrderInvalid_InvalidMessageException")
    {
        ...
        std::string newOrderSingleRawFIX;
        std::string delimSOH = "\x01";
        newOrderSingleRawFIX = "8=FIX.4.2" + delimSOH + "35=A" + delimSOH + "9=114" + delimSOH + "34=2" + delimSOH + "49=ISLD" + delimSOH + "56=TW" + delimSOH + "52=20190517-16:08:43" + delimSOH + "98=0" + delimSOH + "108=1" + delimSOH + "10=166" + delimSOH;
    ...
    SECTION("invalidRawFixMessage_LogonMessageParsingError_InvalidMessageException")
    {
        ...
        newOrderSingleRawFIX = "8=FIX.4.2" + delimSOH + "9=114" + delimSOH // missing Message type in header (35=A)
                               + "34=2" + delimSOH + "49=ISLD" + delimSOH + "56=TW" + delimSOH + "52=20190517-16:08:43" + delimSOH + "98=0" + delimSOH + "108=1" + delimSOH + "10=166" + delimSOH;
    ...
    SECTION("invalidRawFixTMessage_LogonMessageHeaderOrderInvalid_InvalidMessageException")
    {
        ...
        std::string newOrderSingleRawFIX;
        std::string delimSOH = "\x01";
        newOrderSingleRawFIX = "8=FIXT.4.2" + delimSOH + "35=A" + delimSOH + "9=114" + delimSOH + "34=2" + delimSOH + "49=ISLD" + delimSOH + "56=TW" + delimSOH + "52=20190517-16:08:43" + delimSOH + "98=0" + delimSOH + "108=1" + delimSOH + "10=166" + delimSOH;
    ...
    SECTION("lookUpSession_SessionFound")
    {
        startLoggedOn();
        std::string delimSOH = "\x01";
        std::string header = "8=FIX.4.2" + delimSOH + "9=100" + delimSOH + "35=A" + delimSOH + "49=TW" + delimSOH + "56=ISLD" + delimSOH;
