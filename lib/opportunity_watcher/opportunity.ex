defmodule OpportunityWatcher.Opportunity do
  ...
  def profit(trading_path, price_quantity_map, commission_percentage) do
    ...
    |> Enum.reduce(1, fn price, acc -> acc * (1 - commission_percentage) / price end)
    |> Kernel.-(1)
  end
  ...
  """
  def capacity(trading_path, price_quantity_map) do
    ...
    |> Kernel./(1 + profit_without_commission(trading_path, price_quantity_map))
  end
