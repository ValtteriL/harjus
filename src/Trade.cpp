...
enum Position Trade::getPosition() const
{
  return position_;
}
...
const Symbol &Trade::getSymbol() const
{
  return symbol_;
}
...
std::string_view Trade::getRecvCurrency() const
{
  return recvCurrency_;
}

std::string_view Trade::getUsedCurrency() const
{
  return usedCurrency_;
}
