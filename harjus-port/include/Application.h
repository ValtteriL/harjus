...
private:
  ...
  /**
   * This provides you with a peek at the administrative messages that are being sent from your FIX engine to the counter party.
  ...
  /**
   * This notifies you when an administrative message is sent from a counterparty to your FIX engine.
   ...
   * If a FieldNotFound exception is thrown, the counterparty will receive a reject indicating a conditionally required field is missing.
