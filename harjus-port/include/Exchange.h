...
/**
 * @file Exchange.h
 * @brief Exchange class. Contains logic for fetching exchange information and prices.
 * @details This class is used to fetch exchange information and prices from the exchange API.
 */
 ...
 * @param config Configuration object containing API keys and other settings.
 * @return A map of symbol names to Symbol objects containing symbol information.
 */
 ...
 * @param config Configuration object containing API keys and other settings.
 * @param symbols A map of symbol names to Symbol objects containing symbol information.
